...
#Notes: Knowing when the particles are at equilibrium seems to be the biggest challege. Not only does entropy not reach an ideal value, but the value seems to decrease after a certain point.
